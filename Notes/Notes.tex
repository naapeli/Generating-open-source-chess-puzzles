...
Computing if the fen position is legal and unique is surprisingly costly (why?)

Perhaps we could ask the authors for the implementation of the uniqueness and counter-intuitiveness so we can measure differences between models exactly.

Perhaps new thing we could do is that we could modify the counter intuitiveness threshold by considering the difficulty rating of the puzzle (more difficult puzzle is more counter-intuitive)
