...
def process_puzzle(tokens, base_theme, base_rating, random_themes, device, rating_model):
    ...
    try:
        ...
        if puzzle is not None:
            ...
            existing_themes_one_hot = torch.from_numpy(
                theme_preprocessor.transform([existing_themes])
            ...
            if random_themes:
                ...
                entry["themes_match"] = len(set(base_theme).intersection(existing_themes)) > len(base_theme) // 2
