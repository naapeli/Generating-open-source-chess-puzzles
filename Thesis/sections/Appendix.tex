...
\begin{figure}[h]
    ...
    \caption{The counter-intuitive rate for the Lichess puzzles dataset, our supervised model and the final model across all themes. All positions are first filtered for positions with a unique solution and so that the themes match the ones the model was conditioned on, and the percentages are computed across the filtered dataset.}
