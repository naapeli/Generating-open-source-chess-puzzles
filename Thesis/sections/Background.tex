...
With this notation, we begin by examining the forward process in discrete time. Then, we follow \citeauthor{shi2025simplifiedgeneralizedmaskeddiffusion} to generalize and take the limit as the number of discrete time steps approaches infinity.
