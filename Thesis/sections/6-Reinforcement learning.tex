...
where each transition is deterministic. The action probabilities $p_\theta(x_{t - 1} | x_t)$ are given by \eqref{eq:reverse process x_0 unknown} and 
